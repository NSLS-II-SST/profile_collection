...
def do_some_eputables_2021_en():
    ...
    yield from buildeputable(200, 500, 10, 2, 23704, 0, "L", "1200", "mL0_1200")
    yield from buildeputable(200, 500, 10, 2, 23148, 4000, "L", "1200", "mL4_1200")
    yield from buildeputable(200, 500, 10, 2, 20922, 8000, "L", "1200", "mL8_1200")
    yield from buildeputable(200, 500, 10, 2, 17383, 12000, "L", "1200", "mL12_1200")
    yield from buildeputable(250, 500, 10, 2, 17150, 15000, "L", "1200", "mL15_1200")
    yield from buildeputable(250, 500, 10, 2, 15684, 18000, "L", "1200", "mL18_1200")
    yield from buildeputable(250, 500, 10, 2, 15805, 21000, "L", "1200", "mL21_1200")
    yield from buildeputable(250, 500, 10, 2, 16434, 23000, "L", "1200", "mL23_1200")
    yield from buildeputable(250, 500, 10, 2, 17470, 26000, "L", "1200", "mL26_1200")
    yield from buildeputable(200, 500, 10, 2, 16373, 29500, "L", "1200", "mL29p5_1200")

    yield from buildeputable(200, 500, 10, 2, 23704, 0, "L3", "1200", "m3L0_1200")
    yield from buildeputable(200, 500, 10, 2, 23148, 4000, "L3", "1200", "m3L4_1200")
    yield from buildeputable(200, 500, 10, 2, 20922, 8000, "L3", "1200", "m3L8_1200")
    yield from buildeputable(200, 500, 10, 2, 17383, 12000, "L3", "1200", "m3L12_1200")
    yield from buildeputable(250, 500, 10, 2, 17150, 15000, "L3", "1200", "m3L15_1200")
    yield from buildeputable(250, 500, 10, 2, 15684, 18000, "L3", "1200", "m3L18_1200")
    yield from buildeputable(250, 500, 10, 2, 15805, 21000, "L3", "1200", "m3L21_1200")
    yield from buildeputable(250, 500, 10, 2, 16434, 23000, "L3", "1200", "m3L23_1200")
    yield from buildeputable(250, 500, 10, 2, 17470, 26000, "L3", "1200", "m3L26_1200")
    yield from buildeputable(200, 500, 10, 2, 16373, 29500, "L3", "1200", "m3L29p5_1200")
