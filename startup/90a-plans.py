...
def do_2020_eputables2():
    ...
    yield from buildeputablegaps(15400, 70000, 200, 1.3, 90,  '_March_H1phase0',0)
    yield from buildeputablegaps(14000, 70000, 200, 2, 150, '_March_H1phase29500',29500)
    yield from buildeputablegaps(14000, 70000, 200, 2, 175, '_March_H1phase25000',26000)
    yield from buildeputablegaps(14000, 70000, 200, 2, 175, '_March_H1phase25000',23000)
    yield from buildeputablegaps(14000, 70000, 200, 2, 185, '_March_H1phase20000',21000)
    yield from buildeputablegaps(14000, 70000, 200, 2, 200, '_March_H1phase20000',18000)
    yield from buildeputablegaps(14000, 70000, 200, 2, 200, '_March_H1phase16000',15000)
    yield from buildeputablegaps(14000, 70000, 200, 2, 175, '_March_H1phase12000',12000)
    yield from buildeputablegaps(15400, 70000, 200, 1.3, 100, '_March_H1phase8000',8000)
    yield from buildeputablegaps(15400, 70000, 200, 1.3, 100, '_March_H1phase4000',4000)
    yield from buildeputablegaps(14000, 50000, 200, 3, 3*75,  '_March_H3phase0',0)
    yield from buildeputablegaps(14000, 50000, 200, 3, 3*150, '_March_H3phase29500',29500)
    yield from buildeputablegaps(14000, 50000, 200, 3, 3*175, '_March_H3phase25000',26000)
    yield from buildeputablegaps(14000, 50000, 200, 3, 3*175, '_March_H3phase25000',23000)
    yield from buildeputablegaps(14000, 50000, 200, 3, 3*185, '_March_H3phase20000',21000)
    yield from buildeputablegaps(14000, 50000, 200, 3, 3*200, '_March_H3phase20000',18000)
    yield from buildeputablegaps(14000, 50000, 200, 3, 3*200, '_March_H3phase16000',15000)
    yield from buildeputablegaps(14000, 50000, 200, 3, 3*175, '_March_H3phase12000',12000)
    yield from buildeputablegaps(14000, 50000, 200, 3, 3*100, '_March_H3phase8000',8000)
    yield from buildeputablegaps(14000, 50000, 200, 3, 3*100, '_March_H3phase4000',4000)
   # yield from buildeputablegaps(14000, 80000, 200, 2, 200, '_March_H1Circ', 15000)
