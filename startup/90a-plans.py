...
def do_2020_eputables2():
    yield from buildeputablegaps(15000, 40000, 500, 1, 175, 'H1phase12000',12000)
    yield from bps.mv(mono_en,600)
    yield from bps.mv(mono_en,400)
    yield from bps.mv(mono_en,200)
    ...
    yield from bps.mv(mono_en,400)
    yield from bps.mv(mono_en,200)
    yield from buildeputablegaps(15000, 40000, 500, 2, 3*75, 'H3phase0',0)
    yield from bps.mv(mono_en,900)
    yield from bps.mv(mono_en,600)
    yield from buildeputablegaps(15000, 40000, 500, 2, 3*150, 'H3phase29500',29500)
    yield from bps.mv(mono_en,900)
    yield from bps.mv(mono_en,600)
    yield from buildeputablegaps(15000, 40000, 500, 3, 3*175, 'H3phase25000',25000)
    yield from bps.mv(mono_en,900)
    yield from bps.mv(mono_en,600)
    yield from buildeputablegaps(15000, 40000, 500, 3, 3*185, 'H3phase20000',21000)
    yield from bps.mv(mono_en,900)
    yield from bps.mv(mono_en,600)
    yield from buildeputablegaps(15000, 40000, 500, 3, 3*200, 'H3phase20000',18000)
    yield from bps.mv(mono_en,900)
    yield from bps.mv(mono_en,600)
    yield from buildeputablegaps(15000, 40000, 500, 3, 3*200, 'H3phase16000',15000)
    yield from bps.mv(mono_en,900)
    yield from bps.mv(mono_en,600)
    yield from buildeputablegaps(15000, 40000, 500, 3, 3*175, 'H3phase12000',12000)
    yield from bps.mv(mono_en,900)
    yield from bps.mv(mono_en,600)
    yield from buildeputablegaps(15000, 40000, 500, 2, 3*100, 'H3phase8000',8000)
    yield from bps.mv(mono_en,900)
    yield from bps.mv(mono_en,600)
    yield from buildeputablegaps(15000, 40000, 500, 2, 3*100, 'H3phase4000',4000)
    yield from bps.mv(mono_en,900)
    yield from bps.mv(mono_en,600)
